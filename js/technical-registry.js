...
(function(root){
  ...
  const STRATEGY_TEMPLATES=[
    ...
    strategy('main-force-wash-reversal-strategy','主力洗盤後轉強','reversal',['盤中跌破支撐後收回','長下影','量能未失控'],['跌破洗盤低點']),
    ...
    strategy('false-breakout-intraday-risk','假突破誘多風險','risk-avoid',['盤中突破前高','收盤跌回壓力','長上影'],['避免追價']),
    strategy('top-distribution-volume-risk','高檔爆量出貨風險','risk-avoid',['接近60日高檔','爆量長上影','收盤偏弱'],['降低追價與曝險']),
